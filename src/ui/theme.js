...
export const styles = StyleSheet.create({
  ...
  button:{minHeight:48,justifyContent:"center",alignItems:"center",paddingHorizontal:16,marginTop:10,borderWidth:2,borderRadius:10},
  buttonSecondaryDark:{borderColor:colors.line,backgroundColor:"transparent"},buttonSecondaryLight:{borderColor:"#68745E",backgroundColor:"#F4ECD6"},
  buttonSelectedDark:{borderColor:colors.focus,backgroundColor:"#29432A"},buttonSelectedLight:{borderColor:"#405C2D",backgroundColor:"#CFE0B5"},
  buttonPressed:{transform:[{translateY:1}]},buttonPressedDark:{backgroundColor:"#31452F"},buttonPressedLight:{backgroundColor:"#DED3B6"},buttonFocusedDark:{borderColor:colors.focus},buttonFocusedLight:{borderColor:"#17627A"},
  buttonPrimary:{backgroundColor:colors.hazardYellow,borderColor:colors.ink,minHeight:58},buttonPrimaryDisabled:{backgroundColor:"#C8AD4C",borderColor:"#5C552F"},buttonDisabledDark:{backgroundColor:"#253326",borderColor:"#657261"},buttonDisabledLight:{backgroundColor:"#E4DCC5",borderColor:"#8A826F"},
  buttonTextDark:{color:colors.paper,fontFamily:fonts.body,fontSize:16,fontWeight:"700",textAlign:"center"},buttonTextLight:{color:colors.ink,fontFamily:fonts.body,fontSize:16,fontWeight:"700",textAlign:"center"},buttonPrimaryText:{color:colors.ink,fontFamily:fonts.display,fontSize:15,textAlign:"center"},buttonPrimaryTextDisabled:{color:"#454125"},buttonTextDisabledDark:{color:"#C4CCC0"},buttonTextDisabledLight:{color:"#51584E"},disabled:{opacity:.55},controls:{flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:12,flexWrap:"wrap"},
  ...
  answer:{backgroundColor:colors.paper,borderRadius:8,padding:20,marginTop:20,borderTopWidth:7,borderTopColor:colors.grassGreen},answerHeading:{color:"#526248",fontFamily:fonts.body,fontSize:12,fontWeight:"700",letterSpacing:1.4,marginTop:12},answerTitle:{color:colors.ink,fontFamily:fonts.display,fontSize:20,lineHeight:27,marginTop:6},resolution:{color:colors.ink,fontFamily:fonts.body,fontSize:17,lineHeight:26,marginTop:8},answerMeta:{flexDirection:"row",marginTop:12},ruleRow:{minHeight:48,borderTopWidth:1,borderTopColor:"#CFC3A5",paddingVertical:13},ruleRowDark:{borderTopColor:"#60715C"},ruleName:{color:"#294B29",fontFamily:fonts.body,fontWeight:"700",fontSize:17},ruleNameDark:{color:colors.grassGreen},ruleBody:{color:colors.ink,fontFamily:fonts.body,fontSize:17,lineHeight:26,marginTop:5},ruleBodyDark:{color:"#E2E8DE"},sourceDark:{color:colors.muted,marginTop:12},
